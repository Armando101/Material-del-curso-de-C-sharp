...
namespace Paint
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            colorVarOpc.BackColor = colorVar;   //Asigno al recuadro de colores el color seleccionado
            panelDibujo.BackColor = colorFondo; //Asigno el color de fondo a mi panelDibujo
